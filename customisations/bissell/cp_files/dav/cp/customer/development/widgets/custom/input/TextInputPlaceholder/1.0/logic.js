RightNow.namespace('Custom.Widgets.input.TextInputPlaceholder');
Custom.Widgets.input.TextInputPlaceholder = RightNow.Field.extend({
overrides: {
        constructor: function() {
            ...
            if(this.data.attrs.placeholder)
                this.input.setAttribute("placeholder", this.data.attrs.placeholder);

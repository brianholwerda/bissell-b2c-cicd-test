RightNow.namespace('Custom.Widgets.navigation.ListStainNavigation');
Custom.Widgets.navigation.ListStainNavigation = RightNow.ResultsDisplay.extend({ 
    ...
    _onReportChanged: function(type, args) {
        ...
        if(args[0].data.data.length === 1){
            ...
            var url = '/app/stain_removal/'+this.data.attrs.defining_param+'/' + param_value + this.data.js.format.urlParms;

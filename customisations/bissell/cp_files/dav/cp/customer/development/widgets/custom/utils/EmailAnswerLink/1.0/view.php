<?php /* Originating Release: February 2021 */?>
<div id="rn_<?=$this->instanceID?>" class="<?= $this->classList ?>">
    ...
    <div id="rn_<?=$this->instanceID?>_EmailAnswerLinkForm" class="rn_EmailAnswerLinkForm rn_Hidden">
        ...
        <input autocomplete="email" id="rn_<?=$this->instanceID?>_InputRecipientEmail" type="email"/>
        ...
        <? if($this->data['attrs']['object_type'] === 'answer'):?>
            <? if(!$this->data['js']['isProfile']):?>
                ...
                <input autocomplete="email" id="rn_<?=$this->instanceID?>_InputSenderEmail" type="email" value="<?=$this->data['js']['senderEmail'];?>"/>
            ...
            <? if(!$this->data['js']['senderName']):?>
                ...
                <input autocomplete="given-name" id="rn_<?=$this->instanceID?>_InputSenderName" maxlength="70" type="text" value="<?=$this->data['js']['senderName'];?>"/>

    ...
    <? if ($this->data['attrs']['per_page'] && count($this->data['js']['items']) > $this->data['attrs']['per_page']): ?>
        <rn:block id="paginationSection">
            <ul class="rn_ItemPagination rn_Hidden">
                <li class="rn_ItemPaginationPrevious">
                ...
                <li class="rn_ItemPaginationForward">
...
$( document ).ready(function() {
	...
	$('img#rn_58943').attr('alt', 'Carpet Cleaner');
	
	$(".rn_ItemGroup.rn_SubGroup ul li a").removeClass("rn_ShowChildrenImage");
	$(".rn_ItemGroup.rn_SubGroup ul li a").removeClass("rn_ShowChildren");

<div id="rn_<?= $this->instanceID ?>" class="rn_VisualProductCategorySelector rn_ConnectedProductDisplay">
    ...
    <div class="rn_ItemGroup rn_ItemLevel1 rn_BaseGroup rn_Item_Base_SubItems" id="rn_ConnectedProductDisplay_Base_SubItems">
        <ul id="yui_3_18_1_13_1663089832514_157">
	       ...
	       <? for($i=0; $i<count($this->data['js']['items']); $i++) { ?>
	        ...
	        <li class="rn_Item <?=$rowTypeStyle; ?> rn_ItemWithID1<?=$this->data['js']['items'][$i]['SVC_PROD_ID']; ?> <?=$cannonicalTitle; ?> ">  
	        	<div class="rn_VisualItemContainer" data-id="178246" >  
			        ...
			        <div class="rn_ActionContainer" id="yui_3_18_1_15_1663097893294_164" style="height: 72px;">  
				        <a href="/app/products/detail/p/<?=$this->data['js']['items'][$i]['SVC_PROD_ID']; ?>/~/<?=$cannonicalTitle; ?>" class="rn_ItemLink" data-id="<?=$this->data['js']['items'][$i]['SVC_PROD_ID']; ?>" >
					       <?=$this->data['js']['items'][$i]['PRODUCT_TITLE']; ?>
					    </a>   
					</div>
				</div> 
			</li>

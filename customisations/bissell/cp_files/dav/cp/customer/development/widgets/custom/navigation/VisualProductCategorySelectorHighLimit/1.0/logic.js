RightNow.namespace('Custom.Widgets.navigation.VisualProductCategorySelectorHighLimit');
Custom.Widgets.navigation.VisualProductCategorySelectorHighLimit = RightNow.Widgets.extend({ 
    /**
     * Widget constructor.
     */

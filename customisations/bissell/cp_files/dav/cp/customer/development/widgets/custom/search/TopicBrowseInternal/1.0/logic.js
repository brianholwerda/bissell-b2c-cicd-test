RightNow.namespace('Custom.Widgets.search.TopicBrowseInternal');
Custom.Widgets.search.TopicBrowseInternal = RightNow.Widgets.extend({ 
    /**
     * Widget constructor.
     */
    ...
    displayNextArrow: function(visibleSection, ansCat) {
        ...
        if ($(ansCat).children('section[no="'+moreSections+'"]').length) {
            $(ansCat).next().find('img').not('.rn_answerRightArrow').attr('src','images/arrowleftDark.png').addClass('active');
        } else {
    ...
    displayPreviousArrow: function(visibleSection, ansCat) {
        ...
        if ($(ansCat).children('section[no="'+lessSections+'"]').length) {
            $(ansCat).prev().find('img').not('.rn_answerRightArrow').attr('src','images/arrowleftDark.png').addClass('active');
        } else {

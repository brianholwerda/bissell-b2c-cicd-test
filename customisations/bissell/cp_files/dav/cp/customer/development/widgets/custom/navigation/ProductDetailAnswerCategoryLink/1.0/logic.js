RightNow.namespace('Custom.Widgets.navigation.ProductDetailAnswerCategoryLink');
Custom.Widgets.navigation.ProductDetailAnswerCategoryLink = RightNow.Widgets.extend({ 
    /**
     * Widget constructor.
     */

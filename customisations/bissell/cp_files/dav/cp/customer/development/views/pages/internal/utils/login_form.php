...
<?/*<div class="rn_PageContent rn_LoginForm rn_Container">
   <?/*<div class="rn_ThirdPartyLogin">
    ...
    <div class="rn_StandardLogin">
        <h2>#rn:msg:CUSTOM_MSG_CONTACT_ASK_ADMIN_ACCOUNT_CREATION#</h2><br/>
        <div class="rn_Hidden">
        <rn:widget path="login/LoginForm" redirect_url="/app/account/overview" initial_focus="true" disable_password="false"/><br/>
      </div>
	</div>

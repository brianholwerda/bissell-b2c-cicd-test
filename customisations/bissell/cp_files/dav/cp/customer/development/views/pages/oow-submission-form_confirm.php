	...
	<div>
		<div class="rn_TroubleshootingDivImportant">
			<div class="rn_JustifyCenterMobile">
				...
				<span class="rn_TroubleshootingSpanSuccess">#rn:msg:CUSTOM_MSG_TT_OOW_SUCCESS_TEXT#</span>
			</div>
			<div class="rn_ConfirmationHeaderSpan">
				<span>#rn:msg:CUSTOM_MSG_TT_OOW_RECVD_TEXT#</span>
			</div>
		</div>
		<hr/>
		<div>
			#rn:msg:CUSTOM_MSG_TT_OOW_INCNUM_LBL# #rn:url_param_value:refno#
		</div>
		...
		<div class="rn_TroubleshootingDescriptionSpacing">#rn:msg:CUSTOM_MSG_TT_OOW_CONFIRM_REQUEST_SUMMARY_TEXT#</div>
		<div class="rn_TroubleshootingDescriptionSpacing">#rn:msg:CUSTOM_MSG_TT_OOW_CONFIRM_NEXTSTEPS_TEXT#</div>
	</div>
</div>

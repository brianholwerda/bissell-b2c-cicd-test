<rn:meta title="#rn:php:\RightNow\Libraries\SEO::getDynamicTitle('incident', \RightNow\Utils\Url::getParameter('i_id'))#" template="standard_internal.php" login_required="true" clickstream="incident_view" force_https="true"/>
...
<div class="rn_PageContent rn_RecordDetail rn_IncidentDetail rn_Container">
    <rn:condition incident_reopen_deadline_hours="168">
        ...
        <form id="rn_UpdateQuestion" onsubmit="return false;">
                ...
                <rn:widget path="input/FormSubmit" label_on_success_banner="#rn:msg:YOUR_QUESTION_HAS_BEEN_UPDATED_MSG#" on_success_url="/app/account/questions/list"  error_location="rn_ErrorLocation"/>
        </form>
    <rn:condition_else/>

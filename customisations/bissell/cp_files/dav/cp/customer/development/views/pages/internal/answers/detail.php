<rn:meta title="#rn:php:\RightNow\Libraries\SEO::getDynamicTitle('answer', \RightNow\Utils\Url::getParameter('a_id'))#" template="standard_internal.php" login_required="true" answer_details="true" clickstream="answer_view" />
<article itemscope itemtype="http://schema.org/Article" class="rn_Container">
    <div class="rn_ContentDetail">
        <div class="rn_PageTitle rn_RecordDetail">
            <span class="rn_Summary" itemprop="name"><rn:field name="Answer.Summary" highlight="true"/></span>
        ...
        <div class="rn_PageContent rn_RecordDetail rn_LeftArea">
            ...
            <rn:widget path="feedback/AnswerFeedback" label_title="#rn:msg:WAS_THIS_ANSWER_HELPFUL_MSG#"/>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
		...
		console.log(ytId);
        if(ytId)
        $('.rn_AnswerText').prepend('<div class="player"><iframe width="535" height="300" src="https://www.youtube.com/embed/'+ytId+'" frameborder="0" allowfullscreen></iframe></div>');

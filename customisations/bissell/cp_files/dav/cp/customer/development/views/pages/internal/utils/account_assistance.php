<rn:meta title="#rn:msg:ACCOUNT_ASSISTANCE_LBL#" template="standard_internal.php" login_required="false" redirect_if_logged_in="account/overview"/>
<div class="rn_PageContent rn_Account rn_Container rn_AccountAssistance">
<div class="rn_Hero">
    <div class="rn_Container">
        <h2>#rn:msg:ACCOUNT_ASSISTANCE_LBL#</h2>
    </div>
</div>

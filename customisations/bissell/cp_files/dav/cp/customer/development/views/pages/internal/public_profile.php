<rn:meta title="#rn:php:\RightNow\Libraries\SEO::getDynamicTitle('PublicProfile', \RightNow\Utils\Url::getParameter('user'), array('suffix' => ' - ' . \RightNow\Utils\Config::getMessage(PROFILE_LC_LBL)))#" template="standard_internal.php" clickstream="public_profile"/>

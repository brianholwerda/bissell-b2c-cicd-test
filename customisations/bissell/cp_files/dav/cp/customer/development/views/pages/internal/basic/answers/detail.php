<rn:meta title="#rn:php:\RightNow\Libraries\SEO::getDynamicTitle('answer', \RightNow\Utils\Url::getParameter('a_id'))#" template="basic.php" answer_details="true" clickstream="answer_view" login_required="true" />

...
<div class="rn_PageContent">
	<div class="rn_Hero">
		<div style="color:black;">
			<h1>#rn:msg:CUSTOM_MSG_TT_REPAIR_CONFIRM_HEADER_LBL#</h1>
		</div>
	</div>
	...
	<div>
		<div class="rn_TroubleshootingDivImportant">
			<div class="rn_JustifyCenterMobile">
				...
				<span class="rn_TroubleshootingSpanSuccess">#rn:msg:CUSTOM_MSG_TT_REPAIR_SUCCESS_TEXT#</span>
			</div>
			<div class="rn_ConfirmationHeaderSpan">
				<span>#rn:msg:CUSTOM_MSG_TT_REPAIR_RECVD_TEXT#</span>
			</div>
		</div>
		<hr/>
		<div>
			#rn:msg:CUSTOM_MSG_TT_REPAIR_INCNUM_LBL# #rn:url_param_value:refno#
		</div>
		...
		<div class="rn_TroubleshootingDescriptionSpacing">#rn:msg:CUSTOM_MSG_TT_REPAIR_CONFIRM_REQUEST_SUMMARY_TEXT#</div>
		<div class="rn_AnswerPreview rn_TroubleshootingDescriptionSpacing">#rn:msg:CUSTOM_MSG_TT_REPAIR_CONFIRM_SUMMARY_LISTOPTIONS#</div>
		<div class="rn_TroubleshootingDescriptionSpacing">#rn:msg:CUSTOM_MSG_TT_REPAIR_CONFIRM_OVERVIEW_TEXT#</div>
		<div class="rn_TroubleshootingDescriptionSpacing">#rn:msg:CUSTOM_MSG_TT_REPAIR_CONFIRM_NEXTSTEPS_TEXT#</div>
	</div>
</div>

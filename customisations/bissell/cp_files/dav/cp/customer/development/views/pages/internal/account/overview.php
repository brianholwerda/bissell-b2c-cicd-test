<rn:meta title="#rn:msg:ACCOUNT_OVERVIEW_LBL#" template="standard_internal.php" login_required="true" force_https="true" />

<div class="rn_Hero">
    <div class="rn_Container rn_AccountOverview">

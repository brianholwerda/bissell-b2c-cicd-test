<rn:meta title="#rn:php:\RightNow\Libraries\SEO::getDynamicTitle('PublicProfile', \RightNow\Utils\Url::getParameter('user'), array('suffix' => ' - ' . \RightNow\Utils\Config::getMessage(PROFILE_LC_LBL)))#" template="mobile.php" login_required="true"  clickstream="public_profile"/>

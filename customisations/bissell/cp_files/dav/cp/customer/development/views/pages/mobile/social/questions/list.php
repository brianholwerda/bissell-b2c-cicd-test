<rn:meta title="#rn:msg:FIND_DISCUSSIONS_LBL#" template="standard.php" clickstream="answer_list" login_required="true" />
...
<div class="rn_Container">
    <div class="rn_PageContent rn_QuestionList">
        <h2> <i class="fa fa-comments" aria-hidden="true"></i> #rn:msg:RESULTS_FROM_THE_COMMUNITY_LBL#</h2>

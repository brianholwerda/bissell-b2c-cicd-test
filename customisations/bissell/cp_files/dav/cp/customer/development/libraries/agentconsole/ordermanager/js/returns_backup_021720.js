...
function setBillToShipToAddressFromContact(override) {
    ...
    if (!hasBillTo) {
        ...
        o.setValue('BillToPhone', phone);

        billToCountry = countryId;
...
function orderSubmitSuccessCallback(data) {
	...
	if (hasValue(data.TrackingNumber)) {
...
function isOrderValid() {
    ...
    if (addressValidated != 1) {
        message = message + 'Validate addresses before submitting the RA \n\n';
        isvalid = false;
    }

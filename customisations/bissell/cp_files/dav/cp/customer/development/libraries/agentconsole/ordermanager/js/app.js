...
function isFreeShipping(){
    ...
    function isOrderValid() {
		...
		if (hasValue(billToPostal) && ((billToCountry == CA_COUNTRY_ID) || (billToCountry == US_COUNTRY_ID))) {
            var newbilltopostal = getCustomObjectField("BUS", "OrderHeader", "BillToPostalCode");
			var postalvalidation = postalCodeCheck(newbilltopostal, billToCountry);
			if(!postalvalidation){
        ...
        if (hasValue(shipToPostal) && ((shipToCountry == CA_COUNTRY_ID) || (shipToCountry == US_COUNTRY_ID))) {
            var newshiptopostal = getCustomObjectField("BUS", "OrderHeader", "ShipToPostalCode");
			var postalvalidation = postalCodeCheck(newshiptopostal, shipToCountry);
            if(!postalvalidation){

...
//current OSvC object IDs
var currContact = window.external.Contact;
var currIncident = window.external.Incident;
var incidentWorkspace = (currIncident == null) ? false : true;
    ...
    $(document).ready(function ()
    {
		...
		function formatdetail ( d, gridID ) {
			...
			if (d.OnlineReturnTrackingNo)
				trackingLink = '<a href= "https://www.fedex.com/apps/fedextrack/?tracknumbers=' + d.OnlineReturnTrackingNo + '&language=en&cntry_code=us" target="_blank">' + d.OnlineReturnTrackingNo + "</a>";
			...
			for (var i = 0; i < d.OnlineReturnArray.length; i++) {
				...
				if (d.OnlineReturnArray[i].OnlineReturnTrackingNo){
					trackingLink = '<a href= "https://www.fedex.com/apps/fedextrack/?tracknumbers=' + d.OnlineReturnArray[i].OnlineReturnTrackingNo + '&language=en&cntry_code=us" target="_blank">' + d.OnlineReturnArray[i].OnlineReturnTrackingNo + "</a>";
        ...
        orders_table.on('draw', function () {
            ...
            if (incidentWorkspace) {
                ...
                var incOrderNumber = currIncident.GetCustomFieldByName("c$order_number");
                ...
                $('[data-toggle=confirmation]').confirmation({
                    ...
                    onConfirm: function (e) {
                        currIncident.SetCustomFieldByName("c$order_number", parseInt(this.attr('data-order-number')));
                    },
                    popout: true
                });
            }
                ...
                "columns": [
                    ...
                    },
                    {
                        "title": function (data, type, row) {
							return '<a href="https://bissell.custhelp.com/app/answers/detail/a_id/4283/kw/Narvar%20Ship" target="_blank">Initial Est. Delivery</a>';
						},
                    ...
                    }/*,
                    {
						...
						"render": function (data, type, row) {
							if(data == "Y")
								return '<a href="https://rc3.ordergroove.com" target="_blank">Yes</a>';
							return "No";
						},
						"width": "75px"
                    }*//*,
                    ...
                    "dataSrc": function (json) {
                        ...
                        if (json.ResponseMessage == "0 payments found for this order") {
                            ...
                            if (json.ResponseCode == "Success") {
                                ...
                                if (incidentWorkspace && currOrderBalance > 0.00) {

<?php
	...
	{				
		...
		if ($country == 2){
			$sourceVal = $bwsConfig['ENEWS']['CA_SOURCE'];
		} else {
			$sourceVal = $bwsConfig['ENEWS']['US_SOURCE'];
		}
		...
		$bissellResponse = curlExec($bwsConfig, $bwsConfig['ENEWS']['WSDL'], $function, $soapXML);
	...
	{				
		...
		$bissellResponse = curlExec($bwsConfig, $bwsConfig['ENEWS']['WSDL'], $bwsConfig['ENEWS']['IS_SUBBED_FUNCTION'], $soapXML);

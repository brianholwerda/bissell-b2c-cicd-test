    ...
    <div class="page-wrapper">
		...
		<div class="orderheader row spacer form-row">
			<div class="col-sm-2 form-group">
				<label for="nochargereason" class="control-label">Reason for RA</label>
				<div>
			...
			<div class="col-sm-2 form-group"  id="divOrderType" style="display:none;">
				<label for="rewardbalance" class="control-label">Link RA to existing BISSELL Order Number?</label>
				<div>
					<select id="ralinktoorder" name="ralinktoorder" class="form-control" required>
						<option value="">[+]</option>
		...
		<div id="divAllContents" style="display:none;">
            ...
            <div class="row row-padding-left-25">
                ...
                <div class="col-sm-10">
                    <div class="search-form row form-row">
						...
						<div id="qtyAvailableDiv" class="col-sm-2 form-group hidden">
							<label id="qtyAvailablelbl" class="control-label" for="qtyAvailable">Qty Available</label>
                        ...
                        <div class="col-sm-1 form-group">
                            ...
                            <div>
                                <input id="quantity" name="quantity" type="number" class="form-control reset" placeholder="Qty" min="1" max="1" step="1" required disabled />
                            </div>
...
<script type="text/javascript" charset="utf-8" src="<?php echo $serverAssetPath;?>js/returnsflowbui.js"></script>
<script type="text/javascript" charset="utf-8" src="<?php echo $serverAssetPath;?>js/table.returns.js"></script>
<script type="text/javascript" charset="utf-8" src="<?php echo $serverAssetPath;?>js/returnsbui.js"></script>
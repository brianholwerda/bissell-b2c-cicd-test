...
require_once(get_cfg_var('doc_root') . '/custom/src/orderlockgetorderlinecontroller.php');

$getLockController = new OrderLockGetLineController();

// Authorization header is missing or Authentication failed
if(!$getLockController->Initialize())
{
	...
	$json = $getLockController->getOrderLock();

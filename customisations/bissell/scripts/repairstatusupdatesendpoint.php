...
require_once(get_cfg_var('doc_root') . '/custom/src/repairstatusupdatescontroller.php');

$statusUpdate = new RepairStatusUpdatesController();

// Authorization header is missing
if(!$statusUpdate->Initialize())
{
	// Return NULL Contact
...
$status = $statusUpdate->BeginUpdate();
